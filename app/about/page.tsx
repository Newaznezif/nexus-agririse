            ...
            >
              ...
              <div className="relative z-10 flex-1">
                <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-4 mb-5">
                  ...
                  <div className="flex gap-3">
                    <a href="https://www.linkedin.com/in/adonis-wesley-ngoy-b26965309?utm_source=share_via&utm_content=profile&utm_medium=member_android" target="_blank" rel="noreferrer" className="p-2 bg-white dark:bg-zinc-800 rounded-lg text-gray-500 hover:text-blue-600 transition-colors shadow-sm border border-gray-100 dark:border-zinc-700 flex items-center justify-center"><LinkedInIcon /></a>
                    <a href="https://www.facebook.com/adoniswesley.inspirations" target="_blank" rel="noreferrer" className="p-2 bg-white dark:bg-zinc-800 rounded-lg text-gray-500 hover:text-blue-600 transition-colors shadow-sm border border-gray-100 dark:border-zinc-700 flex items-center justify-center"><FacebookIcon /></a>
                    <a href="mailto:adoniswesleyngoy@gmail.com" className="p-2 bg-white dark:bg-zinc-800 rounded-lg text-gray-500 hover:text-orange-600 transition-colors shadow-sm border border-gray-100 dark:border-zinc-700 flex items-center justify-center"><Mail size={20} /></a>
                  </div>
                </div>
                <p className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed">
