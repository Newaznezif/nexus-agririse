...
export default function Home() {
  ...
  return (
    <div className="flex flex-col bg-white dark:bg-black overflow-x-hidden">
      ...
      {/* ── PRICING OPTIONS ── */}
      <section id="pricing" className="py-24 bg-gray-50 dark:bg-zinc-950">
        <div className="container mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-black text-gray-900 dark:text-white mb-6 tracking-tight">
              Transparent Pricing for <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-blue-600">Every Scale</span>
            </h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-7xl mx-auto">
            {/* Starter Plan */}
            <div className="relative flex flex-col p-8 bg-white dark:bg-zinc-900 rounded-3xl border border-gray-200 dark:border-zinc-800 shadow-lg hover:-translate-y-2 transition-transform duration-300">
              <div className="mb-8">
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Starter</h3>
                <p className="text-gray-500 dark:text-gray-400 text-sm h-10">For individual traders and small cooperatives.</p>
              </div>
              ...
              <ul className="flex-1 space-y-4 mb-8">
                {["Access to daily market prices", "Basic crop health data", "Weekly newsletter", "Community forum access"].map((feature) => (
              ...
              <Button label="Get Started" variant="outline" className="w-full justify-center py-4 rounded-xl text-lg" onClick={() => router.push('/signup')} />
            </div>

            {/* Professional Plan */}
            <div className="relative flex flex-col p-8 bg-white dark:bg-zinc-900 rounded-3xl border border-emerald-500 shadow-2xl shadow-emerald-500/10 md:scale-105 z-10 hover:-translate-y-2 transition-transform duration-300">
              ...
              <div className="mb-8">
                ...
                <p className="text-gray-500 dark:text-gray-400 text-sm h-10">For mid-sized agribusinesses and exporters.</p>
              </div>
              ...
              <ul className="flex-1 space-y-4 mb-8">
                {["Real-time arbitrage alerts", "Advanced climate risk scoring", "Exportable PDF reports", "Email & chat support", "Access to AI insights"].map((feature) => (
                  <li key={feature} className="flex items-start">
                    <CheckCircle2 className="h-5 w-5 text-emerald-500 shrink-0 mr-3 mt-0.5" />
                    <span className="text-gray-600 dark:text-gray-300">{feature}</span>
                  </li>
              ...
              <Button label="Start Free Trial" variant="primary" className="w-full justify-center py-4 rounded-xl text-lg" onClick={() => router.push('/signup')} />
            </div>
            ...
            <div className="relative flex flex-col p-8 bg-white dark:bg-zinc-900 rounded-3xl border border-gray-200 dark:border-zinc-800 shadow-lg hover:-translate-y-2 transition-transform duration-300">
              <div className="mb-8">
                ...
                <p className="text-gray-500 dark:text-gray-400 text-sm h-10">For large scale operations and policymakers.</p>
              </div>
              ...
              <ul className="flex-1 space-y-4 mb-8">
                {["Full API access", "Dedicated account manager", "Custom data integrations", "SLA guarantee", "On-premise deployment options"].map((feature) => (
                  <li key={feature} className="flex items-start">
                    <CheckCircle2 className="h-5 w-5 text-emerald-500 shrink-0 mr-3 mt-0.5" />
                    <span className="text-gray-600 dark:text-gray-300">{feature}</span>
                  </li>
              ...
              <Link href="#contact" className="w-full">
                <Button label="Contact Sales" variant="outline" className="w-full justify-center py-4 rounded-xl text-lg" />
              </Link>
            </div>
          </div>
        </div>
